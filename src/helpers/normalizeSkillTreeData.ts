...
import { IMinecraftSkillTreeData, INodePosition, ISkillTree } from "../interfaces";

export const normalizeSkillTreeData = (data: IMinecraftSkillTreeData): {skillTree: ISkillTree, root: string, paths: string[][]} => { 
...
function mapChildren(children:IMinecraftSkillTreeData[], parent: string, skillTree: ISkillTree, newpath: string[] = [], paths: string[][] = []): {childrenArray: string[], paths: string[][]} {
